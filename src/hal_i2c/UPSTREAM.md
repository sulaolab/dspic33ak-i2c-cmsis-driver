...
The files in this directory are a vendor copy of the dsPIC33AK I2C HAL.

Upstream repository:

- Repository: https://github.com/sulaolab/dspic33ak-i2c-hal
- Branch: main
- Source directory: src/

Synchronized into this repository under:

- Destination directory: src/hal_i2c/
